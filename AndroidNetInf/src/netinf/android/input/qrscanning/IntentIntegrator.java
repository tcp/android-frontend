package netinf.android.input.qrscanning;
...
public final class IntentIntegrator {
	...
	public static AlertDialog initiateScan(Activity activity, int stringTitle,
		...
		return initiateScan(activity, activity.getString(stringTitle), activity
				.getString(stringMessage), activity.getString(stringButtonYes),
	...
	public static void shareText(Activity activity, CharSequence text,
			...
			int stringButtonNo) {
		shareText(activity, text, activity.getString(stringTitle), activity
				.getString(stringMessage), activity.getString(stringButtonYes),
				activity.getString(stringButtonNo));
	}
